...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_AliasApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_AliasApi_H_
...
public:
    ...
    explicit AliasApi( std::shared_ptr<const ApiClient> apiClient );
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_AliasApi_H_ */
